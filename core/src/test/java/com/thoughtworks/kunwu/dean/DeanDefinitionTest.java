...
public class DeanDefinitionTest {
    ...
    public void testDefaultScope() throws Exception {
        assertThat(DeanDefinition.defineDean(Object.class).getScope(), is(SINGLETON));
    }

    @Test(expected = IllegalArgumentException.class)
    public void throwExceptionOnIllegalScopeName() throws Exception {
        DeanDefinition.defineDean(Object.class).scope("illegal");
    }
    ...
    public void shouldThrowExceptionIfDefineConstructorTwice() throws Exception {
        ...
        deanDefinition.constructorParams(refByValue("test"));
        deanDefinition.constructorParams(refByValue(new char[]{'a', 'b'}));
    }
